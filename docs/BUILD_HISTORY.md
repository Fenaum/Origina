...
> **Archive:** Sessions 1–18 are in [docs/archive/BUILD_HISTORY_PHASE1.md](archive/BUILD_HISTORY_PHASE1.md)
> (Intake flow, pipeline wiring, workspace buildout, MISMO import, document storage, submission flow, workspace expansion through appraisal/credit/escrow/title)
